...
liveDescribe('Mixed provider team launch live e2e', () => {
  ...
  beforeEach(async () => {
    ...
    previousCliPath = process.env.CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH;
  ...
  afterEach(async () => {
    ...
    restoreEnv('CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH', previousCliPath);
  ...
  it(
    ...
    async () => {
      const orchestratorCli = process.env.CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH?.trim();
