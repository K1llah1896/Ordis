...
describe('ClaudeBinaryResolver', () => {
  ...
  beforeEach(() => {
    ...
    Object.defineProperty(process, 'resourcesPath', {
      value: '/Applications/Ordis.app/Contents/Resources',
      configurable: true,
      writable: true,
    });
  ...
  it('prefers the dedicated CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH override', async () => {
    const expectedBinary = '/Users/belief/dev/projects/claude/agent_teams_orchestrator/cli-dev';
    process.env.CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH = expectedBinary;
  ...
  it('prefers the bundled runtime binary for packaged agent_teams_orchestrator builds', async () => {
    const expectedBinary = path.join(
      '/Applications/Ordis.app/Contents/Resources',
      'runtime',
      'claude-multimodel'
    );
