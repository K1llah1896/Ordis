...
vi.mock('agent-teams-controller', () => ({
  ORDIS_TEAMMATE_OPERATIONAL_TOOL_NAMES: [] as readonly string[],
  ORDIS_NAMESPACED_LEAD_BOOTSTRAP_TOOL_NAMES: [] as readonly string[],
  ORDIS_NAMESPACED_TEAMMATE_OPERATIONAL_TOOL_NAMES: [] as readonly string[],
