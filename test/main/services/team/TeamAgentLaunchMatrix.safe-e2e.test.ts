...
function forceWorkspaceTrustPreflightEnv(): void {
  process.env.ORDIS_WORKSPACE_TRUST_PREFLIGHT = '1';
  process.env.ORDIS_WORKSPACE_TRUST_CLAUDE_PTY = '1';
  process.env.ORDIS_WORKSPACE_TRUST_CODEX_SETTINGS = '1';
  process.env.ORDIS_WORKSPACE_TRUST_RETRY = '0';
}
