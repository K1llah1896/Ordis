...
import { REQUIRED_ORDIS_APP_TOOL_IDS } from '../../../../src/main/services/team/opencode/mcp/OpenCodeMcpToolAvailability';
import {
    ...
    expect(launchOpenCodeTeam).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        members: [
          expect.objectContaining({
            name: 'alice',
            prompt: expect.stringContaining('ORDIS_APP_MANAGED_BOOTSTRAP_V1'),
          }),
        ],
      })
    );
...
function readiness(
  ...
  return {
    ...
    evidence: {
      ...
      observedMcpTools: [...REQUIRED_ORDIS_APP_TOOL_IDS],
