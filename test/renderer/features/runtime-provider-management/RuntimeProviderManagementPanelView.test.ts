...
describe('RuntimeProviderManagementPanelView', () => {
  ...
  it('shows the Windows administrator hint only for OpenCode node_modules symlink EPERM errors', async () => {
    ...
    expect(host.textContent).toContain('Windows: run Ordis as Administrator');
    ...
    expect(host.textContent).not.toContain('Windows: run Ordis as Administrator');
  });
        ...
        React.createElement(RuntimeProviderManagementPanelView, {
          state: createState({
            ...
            errorDiagnostics: {
              ...
              hints: [
                'Check CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH and CLAUDE_CLI_PATH.',
