...
describe('workspaceTrustPreflightEnv', () => {
  it('strips team runtime and provider-routing env while preserving user auth env', () => {
    const env = buildWorkspaceTrustPreflightEnv({
      ...
      ORDIS_RUNTIME_TURN_SETTLED_SPOOL_ROOT: '/Users/tester/spool',
      ORDIS_MCP_CLAUDE_DIR: '/Users/tester/claude-dir',
    ...
    expect(env.ORDIS_RUNTIME_TURN_SETTLED_SPOOL_ROOT).toBeUndefined();
    expect(env.ORDIS_MCP_CLAUDE_DIR).toBeUndefined();
