...
function getStaleTestHomeMaxAgeMs(): number {
  const value = Number(process.env.ORDIS_VITEST_STALE_HOME_MAX_AGE_MS);
...
if (process.env.ORDIS_VITEST_TEMP_CLEANUP_DONE !== '1') {
  process.env.ORDIS_VITEST_TEMP_CLEANUP_DONE = '1';
