...
```bash
CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH=/Users/belief/dev/projects/claude/agent_teams_orchestrator/cli-source \
...
CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH=/Users/belief/dev/projects/claude/agent_teams_orchestrator/cli \
  pnpm vitest run --maxWorkers 1 --minWorkers 1 test/main/services/team/AnthropicLaunchSelection.live.test.ts
```
...
```bash
export CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH=/Users/belief/dev/projects/claude/agent_teams_orchestrator/cli-source
```
...
which points at `cli-source` unless `CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH` is explicitly set.
...
cd /Users/belief/dev/projects/claude/agent_teams_orchestrator
bun run build
export CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH=/Users/belief/dev/projects/claude/agent_teams_orchestrator/cli
```
