...
- preflight fails
- feature flag `ORDIS_WORKSPACE_TRUST_DEBUG=1` is set
...
- Keep all Codex trust settings behind `ORDIS_WORKSPACE_TRUST_CODEX_SETTINGS` so a runtime contract regression can be rolled back without disabling Claude PTY trust preflight.
...
- a diagnostic marker like `ORDIS_WORKSPACE_TRUST_PREFLIGHT=1`
...
```text
ORDIS_WORKSPACE_TRUST_PREFLIGHT=1
```
...
- behind `ORDIS_WORKSPACE_TRUST_RETRY=1`
...
- if settings do not survive Anthropic lead -> Codex teammate inheritance, keep `ORDIS_WORKSPACE_TRUST_CODEX_SETTINGS=0`.
...
```text
ORDIS_WORKSPACE_TRUST_PREFLIGHT=1
ORDIS_WORKSPACE_TRUST_CLAUDE_PTY=1
ORDIS_WORKSPACE_TRUST_CODEX_SETTINGS=1
ORDIS_WORKSPACE_TRUST_RETRY=0
```
...
- if smoke fails only in Codex settings contract, ship Claude PTY with `ORDIS_WORKSPACE_TRUST_CODEX_SETTINGS=0`.
...
```text
ORDIS_WORKSPACE_TRUST_PREFLIGHT=0
ORDIS_WORKSPACE_TRUST_CODEX_SETTINGS=0
ORDIS_WORKSPACE_TRUST_CLAUDE_PTY=0
ORDIS_WORKSPACE_TRUST_ALLOW_UNPROTECTED_CLAUDE=0
ORDIS_WORKSPACE_TRUST_RETRY=0
ORDIS_WORKSPACE_TRUST_FILE_LOCK=0
ORDIS_WORKSPACE_TRUST_DEBUG=0
```
