...
const PASSED_GAUNTLET_REAL_ORDIS_E2E_REASON =
...
export function getOpenCodeTeamModelRecommendation(
  ...
  if (OPENCODE_TEAM_RECOMMENDED_MODELS.has(normalizedModelId)) {
    return {
      level: 'recommended',
      label: 'Recommended',
      reason: PASSED_GAUNTLET_REAL_ORDIS_E2E_REASON,
    };
  }
  ...
  if (OPENCODE_TEAM_TESTED_MODELS.has(normalizedModelId)) {
    return {
      level: 'tested',
      label: 'Tested',
      reason: PASSED_REAL_ORDIS_E2E_REASON,
    };
  }
  ...
  if (OPENCODE_TEAM_TESTED_WITH_LIMITS_MODELS.has(normalizedModelId)) {
    return {
      ...
      reason:
        ...
        PASSED_FREE_ROUTE_REAL_ORDIS_E2E_REASON,
    };
  }
