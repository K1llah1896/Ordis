...
export default interface Resources {
  ...
  dashboard: {
    ...
    windowsAdmin: {
      description: 'OpenCode runtime checks can time out when Ordis is not elevated. Restart the app with Run as administrator before launching OpenCode teams.';
  ...
  settings: {
    ...
    runtimeProvider: {
      ...
      diagnostics: {
        ...
        windowsSymlinkAdminHint: 'Windows: run Ordis as Administrator';
      };
      modelRoutes: {
    ...
    provisioning: {
      ...
      providerStatus: {
        ...
        failureHints: {
          ...
          openCodeNodeModulesSymlinkPermission: 'Run Ordis as Administrator, then retry launch.';
