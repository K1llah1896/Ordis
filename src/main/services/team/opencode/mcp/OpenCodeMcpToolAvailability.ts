...
export const REQUIRED_ORDIS_RUNTIME_TOOLS = REQUIRED_ORDIS_RUNTIME_PROOF_TOOLS;

export type RequiredAgentTeamsRuntimeTool =
  (typeof REQUIRED_ORDIS_RUNTIME_PROOF_TOOLS)[number];
...
export const REQUIRED_ORDIS_APP_TOOL_IDS: readonly string[] =
  REQUIRED_ORDIS_APP_TOOLS.map((tool) =>
