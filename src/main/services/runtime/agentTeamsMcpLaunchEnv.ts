...
const MCP_COMMAND_ENV = 'CLAUDE_MULTIMODEL_ORDIS_MCP_COMMAND';
const MCP_ENTRY_ENV = 'CLAUDE_MULTIMODEL_ORDIS_MCP_ENTRY';
const MCP_ARGS_JSON_ENV = 'CLAUDE_MULTIMODEL_ORDIS_MCP_ARGS_JSON';
const MCP_ENV_JSON_ENV = 'CLAUDE_MULTIMODEL_ORDIS_MCP_ENV_JSON';
