...
if (!env.CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH?.trim()) {
  env.CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH = resolveLiveSmokeOrchestratorCliPath({
    env,
    repoRoot,
  });
}
...
console.log(`Orchestrator CLI: ${env.CLAUDE_ORDIS_ORCHESTRATOR_CLI_PATH}`);
