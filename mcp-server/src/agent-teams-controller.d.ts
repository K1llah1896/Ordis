declare module 'agent-teams-controller' {
  ...
  export const ORDIS_TASK_TOOL_NAMES: readonly string[];
  export const ORDIS_LEAD_TOOL_NAMES: readonly string[];
  export const ORDIS_REVIEW_TOOL_NAMES: readonly string[];
  export const ORDIS_MESSAGE_TOOL_NAMES: readonly string[];
  export const ORDIS_CROSS_TEAM_TOOL_NAMES: readonly string[];
  export const ORDIS_PROCESS_TOOL_NAMES: readonly string[];
  export const ORDIS_KANBAN_TOOL_NAMES: readonly string[];
  export const ORDIS_RUNTIME_TOOL_NAMES: readonly string[];
  export const ORDIS_WORK_SYNC_TOOL_NAMES: readonly string[];
  export const ORDIS_MCP_TOOL_GROUPS: readonly AgentTeamsMcpToolGroup[];
  export const ORDIS_REGISTERED_TOOL_NAMES: readonly string[];
  export const ORDIS_TEAMMATE_OPERATIONAL_TOOL_NAMES: readonly string[];
  export const ORDIS_NAMESPACED_TEAMMATE_OPERATIONAL_TOOL_NAMES: readonly string[];
  export const ORDIS_LEAD_BOOTSTRAP_TOOL_NAMES: readonly string[];
  export const ORDIS_NAMESPACED_LEAD_BOOTSTRAP_TOOL_NAMES: readonly string[];
}
